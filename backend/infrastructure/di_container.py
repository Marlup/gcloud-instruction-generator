...
from backend.services.iam_org_service import IamOrgService
from backend.services.logging_monitor_service import LoggingMonitorService
...
class DIContainer:
    ...
    def __init__(self, config: ConfigurationManager):
        ...
        self._service_classes: Dict[str, Type] = {
            ...
            "iam-org": IamOrgService,
            "logging-monitor": LoggingMonitorService,
