...
__all__ = ["DebugErrorService"]

class DebugErrorService(BaseGCloudService):
    """
    Implementación concreta del servicio GCP DebugErrorService .
    Basada en BaseGCloudService.
    """

    service_name = GCPService.DEBUG_ERROR
