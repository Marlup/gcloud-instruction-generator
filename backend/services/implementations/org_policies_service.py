...
__all__ = ["OrgPoliciesService"]

class OrgPoliciesService(BaseGCloudService):
    """
    Implementación concreta del servicio GCP OrgPolicies .
    Basada en BaseGCloudService.
    """

    service_name = GCPService.ORG_POLICIES
    ...
    def reset_client(self):
        #self.client = gcp_authging.Client(project=self.configuration.project, credentials=self.configuration.credentials)
        return
